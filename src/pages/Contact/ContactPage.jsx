...
import { FaTruck, FaShieldAlt, FaRedoAlt, FaHeadphones } from 'react-icons/fa'
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-[#75b06f]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <FiPhone className="w-8 h-8 text-[#75b06f]" />
              </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-[#75b06f]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <FiMail className="w-8 h-8 text-[#75b06f]" />
              </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-[#75b06f]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <FiMapPin className="w-8 h-8 text-[#75b06f]" />
              </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-[#75b06f]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <FiClock className="w-8 h-8 text-[#75b06f]" />
              </div>
              <h3 className="text-lg font-bold text-gray-800 mb-2">Giờ Làm Việc</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-stretch mb-16">
            ...
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-gray-800">Tại Sao Chọn Fresh Market?</h2>
              ...
              <div className="bg-[#e8f5e7] p-6 rounded-xl hover:shadow-lg transition-shadow">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#4a7548]">
                      100% sản phẩm được kiểm tra chất lượng, nguồn gốc rõ ràng và an toàn cho sức
                      khỏe.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-[#e8f5e7] p-6 rounded-xl hover:shadow-lg transition-shadow">
                <div className="flex items-start gap-4">
                  <div className="bg-[#75b06f] p-3 rounded-xl flex-shrink-0">
                    <FaRedoAlt className="w-7 h-7 text-white" />
                  </div>
                  <div>
              ...
              <div className="bg-[#e8f5e7] p-6 rounded-xl hover:shadow-lg transition-shadow">
                <div className="flex items-start gap-4">
                  <div className="bg-[#75b06f] p-3 rounded-xl flex-shrink-0">
                    <FaHeadphones className="w-7 h-7 text-white" />
                  </div>
                  <div>
                    <h3 className="font-bold text-xl mb-2 text-[#2d5a2b]">Hỗ Trợ 24/7</h3>
                    <p className="text-[#4a7548]">
                      Đội ngũ chăm sóc khách hàng nhiệt tình, sẵn sàng tư vấn và giải đáp mọi thắc
                      mắc.
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-8">
              <div className="bg-[#75b06f] text-white p-8 rounded-2xl">
                <h3 className="text-2xl font-bold mb-4">Bạn Cần Hỗ Trợ Gấp?</h3>
                <p className="mb-6 opacity-90">
                  Đội ngũ chăm sóc khách hàng của chúng tôi luôn sẵn sàng hỗ trợ bạn 24/7. Hãy gọi
                  ngay để được tư vấn và giải đáp mọi thắc mắc.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <FiPhone className="w-5 h-5" />
                    <span className="font-semibold">Hotline: 1900-xxxx (Miễn phí)</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <FiMail className="w-5 h-5" />
                    <span className="font-semibold">support@freshmarket.vn</span>
                  </div>
                </div>
              </div>

              <div className="bg-gray-50 p-8 rounded-2xl">
                <h3 className="text-xl font-bold text-gray-800 mb-4">Câu Hỏi Thường Gặp</h3>

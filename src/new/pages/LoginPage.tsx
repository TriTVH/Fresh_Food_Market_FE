import { Eye, EyeOff, AlertCircle, Leaf, ShoppingBag, Star } from "lucide-react";
...
export function LoginPage({ onPageChange, onLoginSuccess }: LoginPageProps) {
      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 relative overflow-hidden">
          ...
          <div 
            ...
            style={{
              backgroundImage: `url('https://images.unsplash.com/photo-1657288089316-c0350003ca49?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmcmVzaCUyMG9yZ2FuaWMlMjB2ZWdldGFibGVzJTIwbWFya2V0fGVufDF8fHx8MTc2ODU3ODgzNnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral')`
            }}
          >
            ...
            <div>
              ...
              <div>
                ...
                <p className="text-white/90 text-lg leading-relaxed mb-8">
                  Khám phá thế giới thực phẩm tươi sống chất lượng cao từ các trang trại 
                  hữu cơ uy tín trên toàn quốc.
                </p>
              </div>
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500">
                Nhận ưu đãi độc quyền khi đăng nhập ngay hôm nay
              </p>
            </div>
            ...
            <details className="mb-6">
              ...
              <div className="mt-3 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4 space-y-2 border border-gray-200">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-mono bg-white px-2 py-1 rounded text-gray-700">customer@freshmarket.vn / 123456</span>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <span className="text-gray-600">🔑 Admin:</span>
                  <span className="font-mono bg-white px-2 py-1 rounded text-gray-700">admin@freshmarket.vn / admin123</span>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <span className="text-gray-600">🚚 Supplier:</span>
                  <span className="font-mono bg-white px-2 py-1 rounded text-gray-700">supplier@freshmarket.vn / supplier123</span>
                </div>
              </div>
            </details>

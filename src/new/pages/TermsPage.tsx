      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Chào mừng bạn đến với Fresh Market. Bằng việc truy cập và sử dụng
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-start gap-3 mb-4">
              <CheckCircle className="w-6 h-6 text-[#75b06f] flex-shrink-0 mt-1" />
              <div>
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    Khi sử dụng website Fresh Market, bạn xác nhận rằng:
                  </p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-start gap-3 mb-4">
              <Scale className="w-6 h-6 text-[#75b06f] flex-shrink-0 mt-1" />
              <div>
                <h2 className="text-xl font-bold text-gray-800 mb-3">
                ...
                <div className="space-y-3 text-gray-700">
                  ...
                  <p className="mt-4">
                    <strong>2.2. Trách nhiệm:</strong> Bạn chịu trách nhiệm về mọi hoạt động diễn ra dưới tài khoản của mình.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <p className="mt-4">
                <strong>3.3. Thanh toán:</strong> Chúng tôi chấp nhận thanh toán qua COD, thẻ tín dụng/ghi nợ, ví điện tử, chuyển khoản ngân hàng.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                <strong>4.1. Khu vực giao hàng:</strong> Nội thành TP.HCM và các tỉnh thành trên toàn quốc.
              </p>
              <p>
              ...
              <p className="mt-4">
                <strong>4.3. Lưu ý:</strong> Thời gian giao hàng có thể thay đổi do điều kiện thời tiết, giao thông hoặc lý do bất khả kháng.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-start gap-3 mb-4">
              <AlertCircle className="w-6 h-6 text-[#75b06f] flex-shrink-0 mt-1" />
              <div>
                <h2 className="text-xl font-bold text-gray-800 mb-3">
                  5. Hủy Đơn Hàng
                </h2>
                <div className="space-y-3 text-gray-700">
                  ...
                  <p className="mt-4">
                    <strong>5.2. Hoàn tiền:</strong> Hoàn tiền trong vòng 5-7 ngày làm việc kể từ khi hủy đơn thành công.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                Mọi nội dung trên website (logo, hình ảnh, văn bản, thiết kế) là tài sản của Fresh Market và được bảo vệ bởi luật sở hữu trí tuệ.
              </p>
              <p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                Fresh Market không chịu trách nhiệm về:
              </p>
              <ul className="space-y-2 list-disc list-inside ml-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700">
              Fresh Market có quyền thay đổi, bổ sung điều khoản bất cứ lúc nào. Thay đổi sẽ có hiệu lực ngay khi được đăng tải trên website. Việc bạn tiếp tục sử dụng dịch vụ đồng nghĩa với việc chấp nhận các thay đổi.
            </p>
          </div>

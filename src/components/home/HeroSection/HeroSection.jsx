      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="flex justify-center -mt-6 sm:-mt-8 relative z-10 px-2 sm:px-0">
          <form
            ...
            className="bg-white rounded-xl sm:rounded-2xl shadow-2xl px-3 py-3 sm:px-6 sm:py-5 flex items-center gap-2 sm:gap-3 w-full max-w-3xl border border-gray-100"
          >
            <div className="bg-[#f0f9ef] p-2 sm:p-3 rounded-lg sm:rounded-xl">
              <FiSearch className="w-4 h-4 sm:w-5 sm:h-5 text-[#75b06f]" />
            </div>
            <input
              type="text"
            ...
            <button
              type="submit"
              className="bg-[#75b06f] hover:bg-[#63a05d] text-white px-4 py-2 sm:px-8 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base font-semibold transition-all duration-300 hover:shadow-lg"
            >
              Tìm
            </button>
          </form>
